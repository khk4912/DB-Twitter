...
public class PostSearch {
        ...
        try {
            ...
            while(rs.next()) {
                System.out.println("Post ID: " + rs.getInt("post_id") + ", Writer ID: " + rs.getString("user_id_writer") +
                                   ...
                                   ", Update Date: " + rs.getTimestamp("update_date") + ", Registration Date: " + rs.getTimestamp("registration_date") +
    ...
    public void searchByHashTag(String tag) {
        try {
            ...
            searchPstmt.setString(1, tag); // 검색하고자 하는 태그
    ...
    public void searchByLocationTag(String location) {
        try {
            ...
            PreparedStatement searchPstmt = con.prepareStatement(searchSql);
            searchPstmt.setString(1, location); // 검색하고자 하는 장소 태그
            ResultSet rs = searchPstmt.executeQuery();
        ...
        try {
            ...
            while(rs.next()) {
                System.out.println("User ID: " + rs.getString("user_id") + ", Nickname: " + rs.getString("nickname") +
                                   ", Access Date: " + rs.getTimestamp("access_date") + ", Update Date: " + rs.getTimestamp("update_date") +
                                   ...
                                   ", Profile Image: " + rs.getString("profile_image") + ", Introduce: " + rs.getString("introduce") +
